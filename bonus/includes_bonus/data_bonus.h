...
/*   Updated: 2025/08/04 16:17:25 by eklymova         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//DRAW UTILS
void				draw_line(t_data *data, t_fvector a,
						t_fvector b, t_colors color);
...
void				get_fixed_step_between_lines(t_fvector ray,
...
void				draw_floor(t_data *data, int end_pixel,
						t_colors color, int x);
void				draw_celing(t_data *data, int start_pixel,
						t_colors color, int x);
